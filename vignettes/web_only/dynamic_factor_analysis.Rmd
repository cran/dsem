...
```{r fit_MARSS, echo=TRUE, message=FALSE, fig.width=7, fig.height=7}
# Load data
...
```{r plot_MARSS, echo=TRUE, message=FALSE, fig.width=7, fig.height=3.5}
# Plots states using all data
plot(fit_MARSS, plot.type="xtT")
```

And the estimated predictor for measurements (manifest variables):
```{r plot_states_MARSS, echo=TRUE, message=FALSE, fig.width=7, fig.height=7}
...
```{r define_plot_states, echo=TRUE, message=FALSE, fig.width=7, fig.height=7}
...
```{r fit_dsem_fullrank, eval=FALSE, echo=TRUE, message=FALSE, fig.width=7, fig.height=7, warning=FALSE}
...
```{r fit_dsem_lowrank, echo=TRUE, message=FALSE, fig.width=7, fig.height=7}
# Add factors to data
...
```{r plot_dsem_lowrank, echo=TRUE, message=FALSE, fig.width=7, fig.height=3.5}
# Plot estimated factors
plot_states( mydfa, vars=5+seq_len(n_factors) )
```

and the estimated predictor for manifest variables
```{r plot_states_lowrank, echo=TRUE, message=FALSE, fig.width=7, fig.height=7}
...
```{r fit_MARSS_nopen, echo=TRUE, message=FALSE, fig.width=7, fig.height=7}
...
```{r plot_MARSS_nopen, echo=TRUE, message=FALSE, fig.width=7, fig.height=3.5}
# Plots states using all data
...
```{r compare_likelihood, echo=TRUE, message=FALSE, fig.width=7, fig.height=7}
...
```{r compare_loadings, echo=TRUE, message=FALSE, fig.width=7, fig.height=7}
...
```{r run_time, include = FALSE, warning=FALSE, message=FALSE}
